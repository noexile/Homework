...
//	ok 1. Създаване на магазин с предварително подадена вместимост от продукти;
//	ok 2. Създаване на различни видове стоки на килограм –Месо, Сирене, Риба. Всяка стока се създава с наименование, цена и количество;
//	ok 3. Създаване на различни видове стоки на бройка –Бира, Книга, Стол. Всяка стока се създава с наименование, цена и количество;
//	ok 4. Добавяне на стоките в магазина;
//	ok 5. Създаване на купувачи с предварително подадени магазин, брой продукти за	пазаруване и пари в наличност.
//	ok 6. Добавяне на стоки към количката на купувачите;
